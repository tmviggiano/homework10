...
class UserBase(BaseModel):
    first_name: str = Field(max_length=50, examples="John")
    last_name: str = Field(max_length=50, examples="Smith")
    email: EmailStr = Field(examples="john.smith@example.com")
    username: str = Field(min_length=3, max_length=50, example="johnsmith")
